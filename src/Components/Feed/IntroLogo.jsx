...
const IntroLogo = () => {
  ...
  return (
    ...
    className="h-[100vh] w-[100vw] flex justify-center">
       <div ref={parentVideoRef} className="absolute h-[100%] w-[100%] md:mt-[-20px] " >
        <Image ref={imageRef} src={machine}  className={`image-transition ${isVisible ? 'opacity-0' : 'opacity-100'} absolute md:mt-[0px] sm:mt-[50%] mt-[36%]`} />
        {isVisible && 
    ...
    <div ref={movingText} className='font-poppins gradient-text z-20 text-[9vw] flex justify-center mt-[49%] md:mt-[16%] font-extrabold text-center '>
