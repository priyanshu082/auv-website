  ...
  return (
    <div ref={main} className='flex flex-col font-apple bg-black overflow-x-hidden'>
      ...
      <div ref={parentVideoDiv} className='z-20 flex flex-col w-[100vw] h-[100vh] items-center justify-center '>
        <div className='text-gray-200 flex flex-col ml-[60%] font-apple'>
         <h6 className='text-[3vw] '>
         Double Dive
          </h6>
          <p className='pt-[0.5vh] font-medium  text-gray-400 pr-[2vw]'>
      ...
      <div className='z-20 flex flex-col md:flex-row-reverse justify-center items-center w-[100vw] pl-[4vh]'>
        ...
        <div ref={textDiv} className=' text-gray-200 flex flex-col  '>
         ...
         Freaking Fast
          ...
          <p className='pt-[0.5vh] text-gray-400 '>
      ...
      <div className='z-20 flex flex-row mt-[10vh] justify-center items-center w-[100vw] pl-[4vh]'>
        ...
        <div ref={textDiv} className=' text-gray-200 flex flex-col '>
         ...
         Kraken
          ...
          <p className='pt-[0.5vh]  text-gray-400 pr-[2vw]'>
